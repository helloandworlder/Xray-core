...
type ServerConfig struct {
	...
	AccountUsers     map[string]*protocol.User `protobuf:"bytes,5,rep,name=account_users,json=accountUsers,proto3" json:"account_users,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_proxy_http_config_proto_rawDesc = "" +
	"\n" +
	"\x17proxy/http/config.proto\x12\x0fxray.proxy.http\x1a!common/protocol/server_spec.proto\x1a\x1acommon/protocol/user.proto\"A\n" +
	"\aAccount\x12\x1a\n" +
	...
	"\n" +
	"user_level\x18\x04 \x01(\rR\tuserLevel\x12T\n" +
	"\raccount_users\x18\x05 \x03(\v2/.xray.proxy.http.ServerConfig.AccountUsersEntryR\faccountUsers\x1a;\n" +
	"\rAccountsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a[\n" +
	"\x11AccountUsersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.xray.common.protocol.UserR\x05value:\x028\x01\"0\n" +
	"\x06Header\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
...
var file_proxy_http_config_proto_goTypes = []any{
	...
	nil,                             // 5: xray.proxy.http.ServerConfig.AccountUsersEntry
...
var file_proxy_http_config_proto_depIdxs = []int32{
	...
	5, // 1: xray.proxy.http.ServerConfig.account_users:type_name -> xray.proxy.http.ServerConfig.AccountUsersEntry
	...
	7, // 4: xray.proxy.http.ServerConfig.AccountUsersEntry.value:type_name -> xray.common.protocol.User
