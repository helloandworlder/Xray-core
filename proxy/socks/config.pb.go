...
const file_proxy_socks_config_proto_rawDesc = "" +
	...
	"udpEnabled\x12X\n" +
	"\x0eaccount_emails\x18\x05 \x03(\v21.xray.proxy.socks.ServerConfig.AccountEmailsEntryR\raccountEmails\x12\x1d\n" +
	"\n" +
...
var file_proxy_socks_config_proto_depIdxs = []int32{
	...
	5, // 3: xray.proxy.socks.ServerConfig.account_emails:type_name -> xray.proxy.socks.ServerConfig.AccountEmailsEntry
