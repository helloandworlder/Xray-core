...
type ServerConfig struct {
	...
	AccountUsers  map[string]*protocol.User `protobuf:"bytes,7,rep,name=account_users,json=accountUsers,proto3" json:"account_users,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServerConfig) GetAccountUsers() map[string]*protocol.User {
	if x != nil {
...
const file_proxy_socks_config_proto_rawDesc = "" +
	"\n" +
	"\x18proxy/socks/config.proto\x12\x10xray.proxy.socks\x1a\x18common/net/address.proto\x1a!common/protocol/server_spec.proto\x1a\x1acommon/protocol/user.proto\"A\n" +
	"\aAccount\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xf9\x03\n" +
	"\fServerConfig\x127\n" +
	...
	"udpEnabled\x12\x1d\n" +
	"\n" +
	"user_level\x18\x06 \x01(\rR\tuserLevel\x12U\n" +
	"\raccount_users\x18\a \x03(\v20.xray.proxy.socks.ServerConfig.AccountUsersEntryR\faccountUsers\x1a;\n" +
	"\rAccountsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a[\n" +
	"\x11AccountUsersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.xray.common.protocol.UserR\x05value:\x028\x01\"L\n" +
	"\fClientConfig\x12<\n" +
...
var file_proxy_socks_config_proto_goTypes = []any{
	...
	nil,                             // 5: xray.proxy.socks.ServerConfig.AccountUsersEntry
...
var file_proxy_socks_config_proto_depIdxs = []int32{
	...
	5, // 3: xray.proxy.socks.ServerConfig.account_users:type_name -> xray.proxy.socks.ServerConfig.AccountUsersEntry
	7, // 4: xray.proxy.socks.ClientConfig.server:type_name -> xray.common.protocol.ServerEndpoint
	8, // 5: xray.proxy.socks.ServerConfig.AccountUsersEntry.value:type_name -> xray.common.protocol.User
