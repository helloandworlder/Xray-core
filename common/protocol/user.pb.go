...
type User struct {
	...
	// Optional per-user limits enforced inside Xray's dispatch path.
	UplinkLimitBps   int64 `protobuf:"varint,4,opt,name=uplink_limit_bps,json=uplinkLimitBps,proto3" json:"uplink_limit_bps,omitempty"`
	DownlinkLimitBps int64 `protobuf:"varint,5,opt,name=downlink_limit_bps,json=downlinkLimitBps,proto3" json:"downlink_limit_bps,omitempty"`
...
func (x *User) GetUplinkLimitBps() int64 {
	if x != nil {
...
func (x *User) GetDownlinkLimitBps() int64 {
	if x != nil {
...
func (x *User) GetMaxConnections() int32 {
	if x != nil {
...
const file_common_protocol_user_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/protocol/user.proto\x12\x14xray.common.protocol\x1a!common/serial/typed_message.proto\"\xef\x01\n" +
	"\x04User\x12\x14\n" +
	"\x05level\x18\x01 \x01(\rR\x05level\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12:\n" +
	"\aaccount\x18\x03 \x01(\v2 .xray.common.serial.TypedMessageR\aaccount\x12(\n" +
	"\x10uplink_limit_bps\x18\x04 \x01(\x03R\x0euplinkLimitBps\x12,\n" +
	"\x12downlink_limit_bps\x18\x05 \x01(\x03R\x10downlinkLimitBps\x12'\n" +
	"\x0fmax_connections\x18\x06 \x01(\x05R\x0emaxConnectionsB^\n" +
