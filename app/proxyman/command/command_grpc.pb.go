...
const (
	...
	HandlerService_SetUserRateLimit_FullMethodName     = "/xray.app.proxyman.command.HandlerService/SetUserRateLimit"
	HandlerService_RemoveUserRateLimit_FullMethodName  = "/xray.app.proxyman.command.HandlerService/RemoveUserRateLimit"
)
...
func (c *handlerServiceClient) SetUserRateLimit(ctx context.Context, in *SetUserRateLimitRequest, opts ...grpc.CallOption) (*SetUserRateLimitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetUserRateLimitResponse)
	err := c.cc.Invoke(ctx, HandlerService_SetUserRateLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *handlerServiceClient) RemoveUserRateLimit(ctx context.Context, in *RemoveUserRateLimitRequest, opts ...grpc.CallOption) (*RemoveUserRateLimitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveUserRateLimitResponse)
	err := c.cc.Invoke(ctx, HandlerService_RemoveUserRateLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHandlerServiceServer) SetUserRateLimit(context.Context, *SetUserRateLimitRequest) (*SetUserRateLimitResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetUserRateLimit not implemented")
}
func (UnimplementedHandlerServiceServer) RemoveUserRateLimit(context.Context, *RemoveUserRateLimitRequest) (*RemoveUserRateLimitResponse, error) {
...
func _HandlerService_SetUserRateLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetUserRateLimitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServiceServer).SetUserRateLimit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_SetUserRateLimit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).SetUserRateLimit(ctx, req.(*SetUserRateLimitRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HandlerService_RemoveUserRateLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveUserRateLimitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServiceServer).RemoveUserRateLimit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_RemoveUserRateLimit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).RemoveUserRateLimit(ctx, req.(*RemoveUserRateLimitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HandlerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HandlerService_SetUserRateLimit_Handler,
		},
		{
			MethodName: "RemoveUserRateLimit",
			Handler:    _HandlerService_RemoveUserRateLimit_Handler,
		},
	},
