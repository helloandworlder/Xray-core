...
// SetUserRateLimitRequest sets rate limit for a specific user by email.
type SetUserRateLimitRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Uplink        int64                  `protobuf:"varint,2,opt,name=uplink,proto3" json:"uplink,omitempty"`     // bytes per second, 0 for unlimited
	Downlink      int64                  `protobuf:"varint,3,opt,name=downlink,proto3" json:"downlink,omitempty"` // bytes per second, 0 for unlimited
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetUserRateLimitRequest) GetUplink() int64 {
	if x != nil {
		return x.Uplink
	}
	return 0
...
func (x *SetUserRateLimitRequest) GetDownlink() int64 {
	if x != nil {
		return x.Downlink
	}
	return 0
...
// RemoveUserRateLimitRequest removes rate limit for a specific user.
...
const file_app_proxyman_command_command_proto_rawDesc = "" +
	...
	"\rListOutbounds\x12/.xray.app.proxyman.command.ListOutboundsRequest\x1a0.xray.app.proxyman.command.ListOutboundsResponse\"\x00\x12}\n" +
	"\x10SetUserRateLimit\x122.xray.app.proxyman.command.SetUserRateLimitRequest\x1a3.xray.app.proxyman.command.SetUserRateLimitResponse\"\x00\x12\x86\x01\n" +
	"\x13RemoveUserRateLimit\x125.xray.app.proxyman.command.RemoveUserRateLimitRequest\x1a6.xray.app.proxyman.command.RemoveUserRateLimitResponse\"\x00Bm\n" +
...
var file_app_proxyman_command_command_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_app_proxyman_command_command_proto_goTypes = []any{
	...
	(*SetUserRateLimitRequest)(nil),      // 21: xray.app.proxyman.command.SetUserRateLimitRequest
	(*SetUserRateLimitResponse)(nil),     // 22: xray.app.proxyman.command.SetUserRateLimitResponse
	(*RemoveUserRateLimitRequest)(nil),   // 23: xray.app.proxyman.command.RemoveUserRateLimitRequest
	(*RemoveUserRateLimitResponse)(nil),  // 24: xray.app.proxyman.command.RemoveUserRateLimitResponse
	(*Config)(nil),                       // 25: xray.app.proxyman.command.Config
	(*protocol.User)(nil),                // 26: xray.common.protocol.User
	(*core.InboundHandlerConfig)(nil),    // 27: xray.core.InboundHandlerConfig
	(*serial.TypedMessage)(nil),          // 28: xray.common.serial.TypedMessage
	(*core.OutboundHandlerConfig)(nil),   // 29: xray.core.OutboundHandlerConfig
}
var file_app_proxyman_command_command_proto_depIdxs = []int32{
	26, // 0: xray.app.proxyman.command.AddUserOperation.user:type_name -> xray.common.protocol.User
	27, // 1: xray.app.proxyman.command.AddInboundRequest.inbound:type_name -> xray.core.InboundHandlerConfig
	28, // 2: xray.app.proxyman.command.AlterInboundRequest.operation:type_name -> xray.common.serial.TypedMessage
	27, // 3: xray.app.proxyman.command.ListInboundsResponse.inbounds:type_name -> xray.core.InboundHandlerConfig
	26, // 4: xray.app.proxyman.command.GetInboundUserResponse.users:type_name -> xray.common.protocol.User
	29, // 5: xray.app.proxyman.command.AddOutboundRequest.outbound:type_name -> xray.core.OutboundHandlerConfig
	28, // 6: xray.app.proxyman.command.AlterOutboundRequest.operation:type_name -> xray.common.serial.TypedMessage
	29, // 7: xray.app.proxyman.command.ListOutboundsResponse.outbounds:type_name -> xray.core.OutboundHandlerConfig
	...
	21, // 18: xray.app.proxyman.command.HandlerService.SetUserRateLimit:input_type -> xray.app.proxyman.command.SetUserRateLimitRequest
	23, // 19: xray.app.proxyman.command.HandlerService.RemoveUserRateLimit:input_type -> xray.app.proxyman.command.RemoveUserRateLimitRequest
	...
	14, // 26: xray.app.proxyman.command.HandlerService.AddOutbound:output_type -> xray.app.proxyman.command.AddOutboundResponse
	16, // 27: xray.app.proxyman.command.HandlerService.RemoveOutbound:output_type -> xray.app.proxyman.command.RemoveOutboundResponse
	18, // 28: xray.app.proxyman.command.HandlerService.AlterOutbound:output_type -> xray.app.proxyman.command.AlterOutboundResponse
	20, // 29: xray.app.proxyman.command.HandlerService.ListOutbounds:output_type -> xray.app.proxyman.command.ListOutboundsResponse
	22, // 30: xray.app.proxyman.command.HandlerService.SetUserRateLimit:output_type -> xray.app.proxyman.command.SetUserRateLimitResponse
	24, // 31: xray.app.proxyman.command.HandlerService.RemoveUserRateLimit:output_type -> xray.app.proxyman.command.RemoveUserRateLimitResponse
